...
LATEST_TAG=$(gcloud container images list-tags eu.gcr.io/${GCP_PROJECT_NAME}/${APP_NAME}-app --sort-by="~timestamp" --limit=1 --format='value(tags)')
...
PHP_BUILD_IMAGE=eu.gcr.io/${GCP_PROJECT_NAME}/${APP_NAME}-app:${NEW_TAG}
